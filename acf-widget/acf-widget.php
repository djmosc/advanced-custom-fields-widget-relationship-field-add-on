...
class acf_Widget extends acf_Relationship {
	...
	*-------------------------------------------------------------------------------------*/
	...
	function admin_print_scripts() {
		...
		$directory_url = get_template_directory_uri() . '/fields';
		$directory_url = apply_filters( 'acf-widget-directory', $directory_url );
		$directory_url = trailingslashit( $directory_url );

		// proxy function for acf.relationship_update_results
		wp_enqueue_script( 'acf-widget', $directory_url . 'acf-widget/acf-widget.js', array( 'jquery', 'acf-input-actions' ) );

		// styles to account for no search box
		wp_enqueue_style( 'acf-widget', $directory_url . 'acf-widget/acf-widget.css', 'acf-input' );
	...
	*-------------------------------------------------------------------------------------*/
	 ...
	 *
	 *-------------------------------------------------------------------------------------*/
	static function buildIncludeList( $post, $field ) {
	 ...
	 *
	 *-------------------------------------------------------------------------------------*/
	static function getMenuParentIDFromPostID( $post_id = 0, $menu_location ) {
	...
	*
	*-------------------------------------------------------------------------------------*/
	static function getPostIDFromMenuID( $menu_id = 0, $menu_location ) {
